          ...
          <div className="grid grid-cols-3 gap-4">
            {data.products.map(
              ({ _id, title, images, category, price, stock, description }) => (
                <div key={_id} className="bg-white p-6 rounded-lg shadow-lg">
                  <div className="flex   items- space-x-3">
                    ...
                    <div className="flex flex-col  ">
                      ...
                      <p className="text-[10px] font-semibold mt-1">₹{price}</p>
                    </div>
                  </div>
                  ...
                  <div className="mt-4  ">
                    ...
                    <div className="flex justify-between items-center border border-[#2323214D] p-2 rounded-lg text-sm">
                      <p className="text-gray-500 text-[8px] ">Remaining Products</p>
